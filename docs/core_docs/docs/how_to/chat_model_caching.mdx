...
This page goes over key-value caching. To use semantic caching, see [LLM Caching](/docs/integrations/llm_caching).
...
NOTE: This section is for using MongoDB as a key-value LLM caching. For **semantic caching** see [MongoDB Atlas Semantic Cache](/docs/integrations/llm_caching/mongodb_atlas).
